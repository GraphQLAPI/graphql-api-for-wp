...
class ModuleListTable extends AbstractItemListTable
{
    ...
    public function getAllItems(): array
    {
        return [
            ...
            ['id' => 'GraphiQL-for-custom-endpoints', 'enabled' => true, 'has-settings' => true, 'name' => 'GraphiQL for custom endpoints', 'description' => 'So, here I tell you about GraphiQL for custom endpoint, oh yeah you know'],
            ['id' => 'Interactive-schema-for-custom-endpoints', 'enabled' => true, 'has-settings' => true, 'name' => 'Interactive schema for custom endpoints', 'description' => 'So, here I tell you about Interactive schema for custom endpoint, oh yeah you know'],
            ...
            ['id' => 'Access-Control-Rule-User-State', 'enabled' => true, 'has-settings' => false, 'name' => 'Access Control Rule: User State', 'description' => 'So, here I tell you about Access Control by User State, oh yeah you know'],
            ['id' => 'Access-Control-Rule-User-Roles', 'enabled' => true, 'has-settings' => false, 'name' => 'Access Control Rule: User Roles', 'description' => 'So, here I tell you about Access Control by User Roles, oh yeah you know'],
            ['id' => 'Access-Control-Rule-User-Capabilities', 'enabled' => true, 'has-settings' => true, 'name' => 'Access Control Rule: User Capabilities', 'description' => 'So, here I tell you about Access Control by User Capabilities, oh yeah you know'],
            ['id' => 'Cache-Control', 'enabled' => true, 'has-settings' => false, 'name' => 'Cache Control', 'description' => 'So, here I tell you about Cache Control for Persisted Queries, oh yeah you know'],
            ...
            ['id' => 'GraphiQL-Explorer', 'enabled' => true, 'has-settings' => false, 'name' => 'GraphiQL Explorer', 'description' => 'So, here I tell you about Explorer in GraphiQL, oh yeah you know'],
            ...
            ['id' => 'Directive-set-Convert-lower-uppercase', 'enabled' => true, 'has-settings' => true, 'name' => 'Directive set: Convert lower/uppercase', 'description' => 'So, here I tell you about String manipulation directives, oh yeah you know'],
