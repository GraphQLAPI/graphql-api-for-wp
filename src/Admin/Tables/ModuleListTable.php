    ...
    public function getAllItems(): array
    {
        return [
            ...
            [
                ...
                'description' => \__('Expose a fixed response through predefined GraphQL queries, accessed under custom permalinks', 'graphql-api'),
            ],
            [
                'id' => 'custom-endpoints',
                'enabled' => true,
            ...
            [
                ...
                'description' => \__('Enable custom endpoints to be attached a GraphiQL client, to execute queries against them', 'graphql-api'),
            ],
            [
                ...
                'description' => \__('Enable custom endpoints to be attached an Interactive schema client, to visualize the schema from the custom endpoint after applying all the access control rules', 'graphql-api'),
            ],
            [
                'id' => 'access-control',
                'enabled' => true,
            ...
            [
                ...
                'description' => \__('Allow or reject access to the fields and directives based on the user being logged-in or not', 'graphql-api'),
            ],
            [
                ...
                'description' => \__('Allow or reject access to the fields and directives based on the user having a certain role', 'graphql-api'),
            ],
            [
                ...
                'description' => \__('Allow or reject access to the fields and directives based on the user having a certain capability', 'graphql-api'),
            ],
            [
                'id' => 'cache-control',
                'enabled' => true,
                ...
                'description' => \__('Provide HTTP Caching for Persisted Queries: Cache the response by setting the Cache-Control max-age value, calculated from all fields involved in the query', 'graphql-api'),
            ],
            [
            ...
            [
                ...
                'description' => \__('Enable querying for comments in the schema', 'graphql-api'),
            ],
            [
                'id' => 'schema-user-type',
                'enabled' => true,
